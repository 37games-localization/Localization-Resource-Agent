...
用法（与原版完全兼容）：
    ...
    python3 scripts/generate_contract_v2.py --name "宋赛楠"
    python3 scripts/generate_contract_v2.py --name "宋赛楠" --send
    python3 scripts/generate_contract_v2.py --name "宋赛楠" --dry-run
"""
