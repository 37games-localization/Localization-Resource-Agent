...
OPERATION_TABLES = {
    ...
    "contract-info-email": ["candidate", "workflow_log"],
    "contract": ["contract_info", "workflow_log"],
    "signed-contract": ["candidate", "contract_info", "workflow_log"],
    "update-status": ["candidate", "workflow_log"],
    "rejection-email": ["candidate", "workflow_log"],
    "badcase": ["candidate", "workflow_log"],
